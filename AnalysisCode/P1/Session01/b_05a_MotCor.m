...
dirPaths = cell(7,1);
dirPaths{1,1} = fullfile(pathIN, 'P01_Exp2_Run1');
dirPaths{2,1} = fullfile(pathIN, 'P01_Exp2_Run2');
dirPaths{3,1} = fullfile(pathIN, 'P01_Exp3_Run1');
dirPaths{4,1} = fullfile(pathIN, 'P01_Exp3_Run2');
dirPaths{5,1} = fullfile(pathIN, 'P01_Exp1_Run1');
dirPaths{6,1} = fullfile(pathIN, 'P01_Exp1_Run2');
dirPaths{7,1} = fullfile(pathIN, 'P01_Exp1_Run3');
...
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.weight = {'/media/sf_D_DRIVE/MotionQuartet/Analysis/P1/P01_Exp2_Run1/P01_Exp2_Run1_SCSTBL_brain.nii'};

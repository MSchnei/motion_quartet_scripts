...
epiNames{1}=fullfile(dp,'P01_Exp2_Run1','P01_Exp2_Run1_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{2}=fullfile(dp,'P01_Exp2_Run2','P01_Exp2_Run2_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{3}=fullfile(dp,'P01_Exp3_Run1','P01_Exp3_Run1_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{4}=fullfile(dp,'P01_Exp3_Run2','P01_Exp3_Run2_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{5}=fullfile(dp,'P01_Exp1_Run1','P01_Exp1_Run1_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{6}=fullfile(dp,'P01_Exp1_Run2','P01_Exp1_Run2_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{7}=fullfile(dp,'P01_Exp1_Run3','P01_Exp1_Run3_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
...
for ind=1:nr_epis;
    ...
    unix(['fsl5.0-applytopup -i ',...
         ...
         '--topup=P01_topup_results_Session01_readout ',...
         '--inindex=1 ',...
         '--method=jac ',...
         '--interp=spline ',...

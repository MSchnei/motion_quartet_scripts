...
clc; clear all;
dp = '/media/sf_D_DRIVE/MotionQuartet/Analysis/P1/TU/Session01';

% Load AP and PA phase '.fmr'
phaseEncFilename_1 = fullfile(dp,'P01_para_SCSTBL_3DMCTS_LTR_THPGLMF2c_3DMCTS.fmr');
phaseEncFilename_2 = fullfile(dp,'P01_anti_SCSTBL_3DMCTS_LTR_THPGLMF2c_3DMAS.fmr');
...
%% Merge
disp('Merging files...')
unix(['fsl5.0-fslmerge -t P01_para_anti_merge ',...
     [phaseEncFilename_1(1:end-3),'nii '],...
     [phaseEncFilename_2(1:end-3),'nii']]);

%% Topup
disp('Topup is running...')
unix(['fsl5.0-topup --imain=P01_para_anti_merge ',...
      '--datain=acqparams_readout.txt ',...
      '--config=b0_MQ.cnf ',...
      '--out=P01_topup_results_Session01_readout ',...
      '--fout=P01_fieldmap_Session01_readout',...
      ]);

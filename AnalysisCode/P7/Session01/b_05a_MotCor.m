...
dirPaths = cell(5,1);
dirPaths{1,1} = fullfile(pathIN, 'P07_Exp3_Run1');
dirPaths{2,1} = fullfile(pathIN, 'P07_Exp2_Run1');
dirPaths{3,1} = fullfile(pathIN, 'P07_Exp3_Run2');
dirPaths{4,1} = fullfile(pathIN, 'P07_Exp2_Run2');
dirPaths{5,1} = fullfile(pathIN, 'P07_Exp3_Run3');
...
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.weight = {'/media/sf_D_DRIVE/MotionQuartet/Analysis/P7/P07_Exp3_Run1/P07_Exp3_Run1_SCSTBL_brain.nii'};

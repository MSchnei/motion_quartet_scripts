...
epiNames{1}=fullfile(dp,'P07_Exp2_Run3','P07_Exp2_Run3_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{2}=fullfile(dp,'P07_Exp3_Run4','P07_Exp3_Run4_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{3}=fullfile(dp,'P07_Exp2_Run4','P07_Exp2_Run4_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{4}=fullfile(dp,'P07_Exp3_Run5','P07_Exp3_Run5_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{5}=fullfile(dp,'P07_Exp2_Run5','P07_Exp2_Run5_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');
epiNames{6}=fullfile(dp,'P07_Exp3_Run6','P07_Exp3_Run6_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c.fmr');

% specify path to the reference image that was used for FNIRT
refIma = fullfile(dp,'P07_Exp3_Run1','meanP07_Exp3_Run1_SCSTBL');
% specify path to the outcome warp coefficients from FNIRT
wrpTrf = fullfile(dp,'FNIRT','P07_Exp2_Run3_TO_Exp3_Run1_nonlinear_transf');

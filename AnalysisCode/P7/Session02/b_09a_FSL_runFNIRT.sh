subjDir="/media/sf_D_DRIVE/MotionQuartet/Analysis/P7"
refImaFileName="${subjDir}/P07_Exp3_Run1/meanP07_Exp3_Run1_SCSTBL"
inpImaFileName="${subjDir}/P07_Exp2_Run3/meanP07_Exp2_Run3_SCSTBL"
...
cout="${subjDir}/FNIRT/P07_Exp2_Run3_TO_Exp3_Run1_nonlinear_transf"
# output path for transformed image
iout="${subjDir}/FNIRT/P07_Exp2_Run3_TO_Exp3_Run1_nonlinear_imaTest"

...
var InFmrPath = [
	"/media/sf_D_DRIVE/MotionQuartet/Analysis/P9/TU/Session01/P09_para.fmr",
	"/media/sf_D_DRIVE/MotionQuartet/Analysis/P9/TU/Session01/P09_anti.fmr",
	];

var ListTargetVol = [5, 1];

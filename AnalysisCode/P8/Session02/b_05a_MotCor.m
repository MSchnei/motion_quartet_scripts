...
dirPaths = cell(5,1);
dirPaths{1,1} = fullfile(pathIN, 'P08_Exp2_Run3');
dirPaths{2,1} = fullfile(pathIN, 'P08_Exp3_Run4');
dirPaths{3,1} = fullfile(pathIN, 'P08_Exp2_Run4');
dirPaths{4,1} = fullfile(pathIN, 'P08_Exp3_Run5');
dirPaths{5,1} = fullfile(pathIN, 'P08_Exp2_Run5');
...
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.weight = {'/media/sf_D_DRIVE/MotionQuartet/Analysis/P8/P08_Exp2_Run3/P08_Exp2_Run3_SCSTBL_brain.nii'};

...
epiNames{1}=fullfile(dp,'P08_Exp2_Run3','P08_Exp2_Run3_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c_TRF.fmr');
epiNames{2}=fullfile(dp,'P08_Exp3_Run4','P08_Exp3_Run4_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c_TRF.fmr');
epiNames{3}=fullfile(dp,'P08_Exp2_Run4','P08_Exp2_Run4_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c_TRF.fmr');
epiNames{4}=fullfile(dp,'P08_Exp3_Run5','P08_Exp3_Run5_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c_TRF.fmr');
epiNames{5}=fullfile(dp,'P08_Exp2_Run5','P08_Exp2_Run5_SCSTBL_MotCorSPM_nrw_LTR_THPGLMF5c_TRF.fmr');
...
for i=1:nrEpis;
    ...
    unix(['fsl5.0-applytopup -i ',[epiNames{i}(1:end-4),'.nii.gz '],...
          '-a /media/sf_D_DRIVE/MotionQuartet/Tools/P8/Session01/b_10_TU/acqparams_unwarp_readout.txt ',...
          '--topup=/media/sf_D_DRIVE/MotionQuartet/Tools/P8/Session01/b_10_TU/P08_topup_results_Session01_readout ',...
          '--inindex=1 ',...
          '--method=jac ',...
          '--interp=spline ',...

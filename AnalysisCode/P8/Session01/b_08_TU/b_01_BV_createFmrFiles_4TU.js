...
// Set the output path
var OutPath = "/media/sf_D_DRIVE/MotionQuartet/Analysis/P8/";

// Set the first dicom file paths per run.
var InDicomList = [
				   "/media/sf_D_DRIVE/MotionQuartet/Data/P08/Session01/sortedDicoms/mbep2d_0p8mm_R3_MB1_HF_para_Series0012/MarSch_20171002 -0012-0001-00001.dcm",
				   "/media/sf_D_DRIVE/MotionQuartet/Data/P08/Session01/sortedDicoms/mbep2d_0p8mm_R3_MB1_HF_anti_Series0011/MarSch_20171002 -0011-0001-00001.dcm",
				   ];

// Set the names that each run/exp should have (stc prefixes)
var RunNameList = [
	"TU/Session01/P08_para",
	"TU/Session01/P08_anti",
	];

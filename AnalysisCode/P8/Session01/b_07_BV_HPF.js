...
// Set the output path
var InPath = "/media/sf_D_DRIVE/MotionQuartet/Analysis/P8/";

// Set the names that each run/exp should have (stc prefixes)
var InFmrList = [
	"P08_Exp2_Run1/P08_Exp2_Run1_SCSTBL_MotCorSPM_nrw.fmr",
	"P08_Exp3_Run1/P08_Exp3_Run1_SCSTBL_MotCorSPM_nrw.fmr",
	"P08_Exp2_Run2/P08_Exp2_Run2_SCSTBL_MotCorSPM_nrw.fmr",
	"P08_Exp3_Run2/P08_Exp3_Run2_SCSTBL_MotCorSPM_nrw.fmr",
	"P08_Exp3_Run3/P08_Exp3_Run3_SCSTBL_MotCorSPM_nrw.fmr",
	];

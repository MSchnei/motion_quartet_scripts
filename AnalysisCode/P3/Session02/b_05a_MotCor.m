...
dirPaths = cell(6,1);
dirPaths{1,1} = fullfile(pathIN, 'P03_Exp2_Run3');
dirPaths{2,1} = fullfile(pathIN, 'P03_Exp3_Run4');
dirPaths{3,1} = fullfile(pathIN, 'P03_Exp2_Run4');
dirPaths{4,1} = fullfile(pathIN, 'P03_Exp3_Run5');
dirPaths{5,1} = fullfile(pathIN, 'P03_Exp2_Run5');
dirPaths{6,1} = fullfile(pathIN, 'P03_Exp3_Run6');
...
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.weight = {'/media/sf_D_DRIVE/MotionQuartet/Analysis/P3/P03_Exp2_Run3/P03_Exp2_Run3_SCSTBL_brain.nii'};
